...
namespace AARC {
    namespace TimeSeries_CSV {
        ...
        auto read_csv_file(const std::string &filename) -> std::unique_ptr<AARC::TSData>;
        auto read_csv_partial_file(const std::string &filename) -> std::unique_ptr<AARC::TSData>;
    } // namespace TimeSeries_CSV
} // namespace AARC
